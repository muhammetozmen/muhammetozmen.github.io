...
<div class="certificates-wrap page-content">
  <header class="certificates-header reveal">
    <h1 class="certificates-page-title" data-lang-en="Certificates & Documents" data-lang-tr="Sertifikalar ve Belgeler">Sertifikalar ve Belgeler</h1>
  </header>
  ...
  {% else %}
    <div class="no-certificates reveal">
      ...
      <p data-lang-en="No certificates have been uploaded yet. Please check back later!" data-lang-tr="Henüz herhangi bir sertifika yüklenmedi. Lütfen daha sonra tekrar kontrol edin!">Henüz herhangi bir sertifika yüklenmedi. Lütfen daha sonra tekrar kontrol edin!</p>
    </div>
  {% endif %}
</div>
